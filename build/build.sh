...
__NAME__="tiv: build.sh"
__AUTHOR__="h4rl"
__DESCRIPTION__="Compiles libtiv and tiv into an executable, or just libtiv into a static library"
...
Compiles ${CYAN}libtiv${CLEAR} and ${CYAN}tiv${CLEAR} into an executable${CLEAR}.
